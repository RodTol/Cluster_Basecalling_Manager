...
class Conf:
    ...
    mngt_batch_size = 3
    mngt_outputdir = '/AB_20T_output/nanopore_output/run_files_test/outputs/run_name'#CARTELLA DA INPUT
    mngt_inputdir = '/AB_20T_input/dataset/subset_122G_CliveOME_5mc_dataset_POD5'
    ...
    engine_outputdir = '/AB_20T_output/nanopore_output/run_files_test/outputs/run_name'#CARTELLA DA INPUT
    engine_inputdir = "/AB_20T_input/dataset/subset_122G_CliveOME_5mc_dataset_POD5"
    engine_polling_interval = 1
    engine_id = "dgx002_engine"
    engine_optimal_request_size = batch_size #INPUT
