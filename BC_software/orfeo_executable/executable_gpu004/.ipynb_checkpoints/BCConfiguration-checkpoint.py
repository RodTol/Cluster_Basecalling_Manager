...
class Conf:
    ...
    mngt_batch_size = 3
    mngt_outputdir = '/AB_20T_output/nanopore_output/BC_run_output/run_sup_1_dgx-1_gpu'
    ...
    engine_outputdir = "/AB_20T_output/nanopore_output/BC_run_output/run_sup_1_dgx-1_gpu"
