...
run_name="BC_sup_${num_clients}_clients_${launch_time}_benchmark_gpu002"
...
#nfs01
mkdir -p  /AB_20T_output/nanopore_output/BC_run_logs/$run_name
log_path=/AB_20T_output/nanopore_output/BC_run_logs/$run_name
