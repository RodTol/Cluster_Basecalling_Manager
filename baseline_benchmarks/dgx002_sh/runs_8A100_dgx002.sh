...
#./guppy_5mCG_5hmCG_benchmark.sh /AB_20T_input/dataset/CliveOME_5mc_dataset_POD5/ /AB_20T_output/nanopore_output/benchmark_run_output/ > /u/dssc/tolloi/Cluster_Basecalling_Manager/baseline_benchmarks/logs/dgx002_logs/guppy_dgx002_8A100_5mCG_5hmCG_nfs.txt 2>&1 #lanciata provo con 8 threads
