...
n_gpus=$3
echo -e "${RED}I used ${n_gpus} in this run${RESET}"
echo $n_gpus

launch_time=$(date +'%H-%M')
run_name="dorado_hac_${launch_time}_scaling_${n_gpus}.txt"
...
#nfs01
mkdir -p /AB_20T_output/nanopore_output/linear_scaling_logs/$run_name
log_path=/AB_20T_output/nanopore_output/linear_scaling_logs/$run_name
