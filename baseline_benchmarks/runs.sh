...
./dorado_5mCG_benchmark.sh /AB_20T_input/dataset/CliveOME_5mc_dataset_POD5/ /AB_20T_output/nanopore_output/benchmark_run_output/ > logs/dorado_8A100_5mCG_nfs.txt 2>&1

./guppy_benchmark.sh /AB_20T_input/dataset/CliveOME_5mc_dataset_POD5/ /AB_20T_output/nanopore_output/benchmark_run_output/ > logs/guppy_8A100_no_meth_nfs.txt 2>&1

./guppy_5mCG_benchmark.sh /AB_20T_input/dataset/CliveOME_5mc_dataset_POD5/ /AB_20T_output/nanopore_output/benchmark_run_output/ > logs/guppy_8A100_5mCG_nfs.txt 2>&1
