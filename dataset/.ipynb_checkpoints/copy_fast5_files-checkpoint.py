        ...
        with MultiFast5File(str(output_file), 'w') as output_f5:
            for read_id, read in yield_fast5_reads(input_dir + '/' + input_file, recursive=False):
                    ...
                    if(debug):
                         ...
                         debug=False
copy_with_new_id('/AB_20T_input/dataset/dataset_original', 'nanopore2_20170303_FNFAF09968_MN17024_sequencing_run_170303_NA12878_PC_RAD002_0.fast5', '/AB_20T_input/dataset/dataset_fast5_file_0',600)
